...
//
// Version 1.1.1 January 6, 2019; reinitialization bug fixed in HDLen(Poly_t poly)
//     Thanks to Stefan Rueger for reporting this
//
...
{ hPoly = poly;
  ...
  for (Count_t i = 0; i <= maxNumWeights; i++)
...
{ std::ios_base::fmtflags current_flags = hout.flags();
...
{ std::ios_base::fmtflags current_flags = uout.flags();
